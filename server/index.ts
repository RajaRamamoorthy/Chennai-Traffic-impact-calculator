...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://www.google-analytics.com", "https://analytics.google.com", "https://c.clarity.ms", "https://api.razorpay.com", "https://maps.googleapis.com", "https://api.openweathermap.org"],
